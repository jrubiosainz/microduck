...
SCENE_XML = REPO_ROOT / "assets" / "scene_narrow_corridor.xml"
...
# repository's own location (…/projects/microduck-lab/narrow-corridor-etiquette
...
def load_scene(
    ...
    """Load the corridor scene and assert the robot is the stock walking robot."""
