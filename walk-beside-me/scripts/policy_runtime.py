...
SCENE_XML = REPO_ROOT / "assets" / "scene_walk_beside.xml"
...
# repository's own location (…/projects/microduck-lab/walk-beside-me
# → …/projects/microduck_rl/src/mjlab_microduck/robot/microduck) and can be
# overridden with MICRODUCK_RL_ROBOT_DIR or --robot-dir.
# (…/projects/microduck-lab/walk-beside-me → …/projects/microduck_rl/…)
DEFAULT_ROBOT_DIR = (
    REPO_ROOT.parents[1]
    / "microduck_rl"
    / "src"
