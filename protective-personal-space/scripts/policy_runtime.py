...
SCENE_XML = REPO_ROOT / "assets" / "scene_protective_personal_space.xml"
...
# repository's own location (.../projects/microduck-lab/patrol-and-investigate
...
def load_scene(
    ...
    """Load the training-area scene and assert the robot is the stock walking robot."""
